...
│   └── mcs.h                       # tests of equal predictive ability: model confidence set + Diebold-Mariano — above stats.h/random/random.h/special.h/frame/frame.h; see docs/MCS_DOCUMENTATION.md and docs/MCS_PERFORMANCE_DOCUMENTATION.md
│
