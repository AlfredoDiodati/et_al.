...
├── gzip.h             # gzip container + from-scratch DEFLATE decoder and encoder — general-purpose, no dependency on linalg/mat.h; exists because zlib is not OpenBLAS/GCC (see Dependencies below); the decoder for frame/rdata.h, the encoder for frame/npz.h; see docs/GZIP_DOCUMENTATION.md
│
...
python tests/performance/bench_npz.py      # frame/npz.h + gzip.h vs numpy.savez/zlib
...
As things stand, the core tier holds `linalg/mat.h`, `linalg/decomp.h`, `linalg/solver.h`, `ad.h`, `json.h`, `special.h`, `random.h`, `stats.h`, `mcs.h`, `unit_root.h`, `cointegration.h`, `qlr_test.h`, `gzip.h`, `dist/broadcast.h`, `dist/gauss.h`, `dist/student.h`, `dist/mv/gauss.h`, `dist/mv/student.h`, `dist/mv/matgauss.h`, `solver/optimizer.h`, `solver/adam.h`, `solver/lbfgs.h`, `frame/frame.h`, `frame/csv.h`, `frame/txt.h`, `frame/npy.h`, `frame/npz.h`, `frame/sql.h`, `frame/join.h`, `frame/rdata.h`, and `cluster/cluster.h`; the model tier holds `nn/mlp.h`, `sd/qvarma.h` and `sd/score_driven_location.h`; and the development tier holds everything under `tests/`, `examples/`, and `scripts/`.
