...
├── special.h          # scalar special functions (digamma, normal CDF) — general-purpose, standalone like json.h; double-native by design; see docs/SPECIAL_DOCUMENTATION.md
...
├── stats.h            # sample statistics (mean/variance/correlation, autocorrelation, vector mean, lag-k autocovariance, Newey-West long-run variance) — above linalg/mat.h; see docs/STATS_DOCUMENTATION.md
