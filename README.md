...
As things stand, the core tier holds `linalg/mat.h`, `linalg/decomp.h`, `linalg/solver.h`, `ad.h`, `json.h`, `special.h`, `random/random.h`, `random/lhs.h`, `stats.h`, `inference/mcs.h`, `inference/unit_root.h`, `inference/cointegration.h`, `inference/qlr_test.h`, `dist/broadcast.h`, `dist/gauss.h`, `dist/student.h`, `dist/mv/gauss.h`, `dist/mv/student.h`, `dist/mv/matgauss.h`, `solver/optimizer.h`, `solver/adam.h`, `solver/lbfgs.h`, `frame/frame.h`, `frame/csv.h`, `frame/txt.h`, `frame/npy.h`, `frame/npz.h`, `frame/sql.h`, `frame/join.h`, `frame/rdata.h`, `frame/gzip.h`, and `cluster/cluster.h`; the model tier holds `nn/mlp.h`, `sd/qvarma.h` and `sd/score_driven_location.h`; and the development tier holds everything under `tests/`, `examples/`, and `scripts/`.
