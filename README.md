...
As things stand, the core tier holds `linalg/mat.h`, `linalg/decomp.h`, `linalg/solver.h`, `ad.h`, `json.h`, `special.h`, `random.h`, `stats.h`, `mcs.h`, `gzip.h`, `dist/broadcast.h`, `dist/gauss.h`, `dist/student.h`, `dist/mv/gauss.h`, `dist/mv/student.h`, `solver/optimizer.h`, `solver/adam.h`, `frame/frame.h`, `frame/csv.h`, `frame/txt.h`, `frame/npy.h`, `frame/sql.h`, and `frame/rdata.h`; the model tier holds `nn/mlp.h`; and the development tier holds everything under `tests/`, `examples/`, and `scripts/`.
