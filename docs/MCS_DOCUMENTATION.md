...
`docs/MCS_PERFORMANCE_DOCUMENTATION.md` has the mechanism, what the second and larger win actually was, how the harness establishes agreement before cost, why the memory is counted rather than read off resident set size, and what was tried and rejected.
