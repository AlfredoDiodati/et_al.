...
SUITES="test_mat test_mat_special test_decomp test_solver test_special test_stats test_random test_mcs test_mcs_variance test_broadcast test_gauss test_student test_mvgauss test_mvstudent test_ad test_tape_reset test_adam test_optimizer test_cluster test_mlp test_frame test_csv test_txt test_npy test_json test_sql gzip_inflate rdata_array_read"
